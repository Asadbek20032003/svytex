  ...
  return (
    <section className="bg__image_air flex items-center">
      <div className=" container m-auto">
        <div className="md:justify-between md:flex-row flex flex-col  justify-center items-center  w-full">
          <div className="w-full flex flex-col items-start justify-center">
            <h1 className="gradient__text sm:text-[110px] lm:text-[80px] text-[60px] font-bold">AirDrop</h1>
            <p className="sm:text-[20px] lm:text-[14px] text-[12px] text-[#555555] font-bold">
